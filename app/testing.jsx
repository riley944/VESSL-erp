...
export default function Testing({ userEmail = '' }) {
  ...
  // the Sample-but-ordered shortcut included. Exporting the unfiltered set would make
  ...
  const exportXlsx = async () => {
    ...
    try {
      ...
      fs2.addRow(['Rows in this file', shownProducts.length]);
  ...
  return (
    <div style={{background:'#fff',borderRadius:'20px',boxShadow:'0 1px 3px rgba(0,0,0,.04)',overflow:'hidden'}}>
      ...
      <div style={{display:'grid',gridTemplateColumns:PROD_COLS,gap:'16px',padding:'13px 22px',borderBottom:'1px solid rgba(0,0,0,.06)',background:'#FAFAFB'}}>
        {[{label:'Product'},{label:'Stage',span:2,align:'center'},{label:'Testing Date',align:'center'},{label:'Compliance',align:'center'}].map(({label,span,align},i)=>(
